...
frame = tk.Frame(master=root,bg="Cyan",padx=10)
frame.pack()
...
def equal():
    try:
        ...
        tk.messagebox.showinfo("Error","SyntaxError")
...
button_2.grid(row=2,column=0,pady=2)
...
button_clear.grid(row=6,column=2,columnspan=2,pady=2)
